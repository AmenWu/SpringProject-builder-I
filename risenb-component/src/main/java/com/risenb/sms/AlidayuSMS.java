...
public class AlidayuSMS {
	...
	//阿里大于升级后使用方法
		public static boolean sendSmsNew(String mobile, String signName, String content, String template)
			...
			IClientProfile profile = DefaultProfile.getProfile("cn-hangzhou", SMSConstant.ALI_APPKEY,SMSConstant.ALI_SECRET);
		...
		/*public static void main(String[] args) throws ServerException, ClientException {
			String content="{\"code\":\"123456\"}";
			boolean flag = sendSmsNew("18301082685","能康大医生",content,"SMS_83180255");
