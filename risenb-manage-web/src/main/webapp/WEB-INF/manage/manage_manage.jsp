                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
						<div style="margin-bottom: 10px;display: inline-block;">
							<a href="javascript:"open-type="open"  data-width="840px" data-height="450px"  data-url="<%=basePath%>manage/toSavePage.im" class="btn btn-primary"><i class="fa fa-plus"></i> 新增</a>
						</div>
						<!-- 页面表单 -->
                               ...
                               <c:forEach var="manage" items="${page.results}">
                                	<tr class="gradeX">
                                  		 <td>${manage.userName }</td>
                               		     <td>${manage.name}</td>
                               		     <td>${manage.phone}</td>
                               		     <td><fmt:formatDate value="${manage.createTime}" type="both"/></td>
                               		     <td><fmt:formatDate value="${manage.operaTime}" type="both"/></td>
