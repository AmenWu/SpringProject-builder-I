                ...
                <div class="ibox float-e-margins">
                    ...
                    <c:if test="${!empty sessionScope.permissionMap['role/toSavePage.im'] and !empty sessionScope.permissionMap['role/save.im']}">
						<div style="margin-bottom: 10px;display: inline-block;" >
							<a href="javascript:"open-type="open"  data-width="600px" data-height="600px"  data-url="<%=basePath%>role/toSavePage.im" class="btn btn-primary"><i class="fa fa-plus"></i> 新增</a>
						</div>
                    </c:if>
						<!-- 页面表单 -->
