 ...
 * <p>Build: 2017年8月23日 上午11:04:35 </p>
 * </pre>
 *
 * @author Chang Yuxin
 * @version 1.0
...
public class SystemInfo {
	...
	public SystemInfo() {
		...
		// JVM版本信息
		jvmVersion = System.getProperty("java.specification.name") + " " + System.getProperty("java.specification.version") + " "
				+ System.getProperty("java.specification.vendor");

		// 服务器端口

		serverPort = getLocalPort();
	}
